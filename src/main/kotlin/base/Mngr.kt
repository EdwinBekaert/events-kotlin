...
abstract class Mngr : Base(), MngrInterface {
    ...
    protected inline fun <reified E: Ent> getEntCasted(objReq: Req, args: Args, entIdField: String, qryData: Query? = null)
            = objReq.getEnt<E>(args = args, entIdField = entIdField, qryData = qryData) as E
